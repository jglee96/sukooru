...
import { c as createError$1, p as parseURL$1, k as encodePath$1, l as decodePath, m as hasProtocol, n as isScriptProtocol, h as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch, q as executeAsync, r as defu } from '../nitro/nitro.mjs';
...
const unhead_MRMGLEP8hFEbu5v3eCCfWH9iVmR_2gYqpbHD4vN7NWM = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "products",
    path: "/products",
    component: () => import('./products-CFUEl3Vz.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-j2eV50t-.mjs')
  }
];
...
const revive_payload_server_oOHucb5L74olX34EMcex48fJq7XjNRNsw1umx0Wy_ME = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_MRMGLEP8hFEbu5v3eCCfWH9iVmR_2gYqpbHD4vN7NWM,
  plugin,
  revive_payload_server_oOHucb5L74olX34EMcex48fJq7XjNRNsw1umx0Wy_ME,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bou2MG89.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DClghCFq.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@4.4.2_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@emna_7c3b0e95c6817a43ae3adce53b363457/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@4.4.2_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@emna_7c3b0e95c6817a43ae3adce53b363457/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, asyncDataDefaults as a, useRoute as b, createError as c, useRouter as d, entry_default as default, encodeRoutePath as e, fetchDefaults as f, useRuntimeConfig as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
